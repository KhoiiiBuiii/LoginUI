...
public class PolicyOwnerPageControl {
    ...
    public void handleManageClaimsButton() {
        ...
        deleteButton.setOnAction(event -> handleDeleteClaim());

        buttonsContainer.getChildren().addAll(fileButton, viewButton, updateButton, deleteButton);
        additionalContentContainer.getChildren().add(buttonsContainer);
    }
    ...
    public void handleDeleteClaim() {
        ...
        Label titleLabel = new Label("Delete Claim");
        additionalContentContainer.getChildren().add(titleLabel);
        ...
        for (String claim : claims) {
            Hyperlink claimLink = new Hyperlink(claim);
            claimLink.setOnAction(event -> showClaimDeleteDetails(claim));
            claimsList.getChildren().add(claimLink);
        }
    ...
    private void showClaimDeleteDetails(String claim) {
        clearAdditionalContent();

        Label titleLabel = new Label("Delete Claim: " + claim);
        additionalContentContainer.getChildren().add(titleLabel);
        ...
        Button deleteButton = new Button("Delete");
        deleteButton.setOnAction(event -> deleteClaim(claim));

        additionalContentContainer.getChildren().addAll(claimDetails, deleteButton);
    }

    private void deleteClaim(String claim) {
        clearAdditionalContent();

        // Placeholder logic to delete the claim
        Label deletionConfirmation = new Label("Claim '" + claim + "' has been deleted.");
        additionalContentContainer.getChildren().add(deletionConfirmation);
    }
